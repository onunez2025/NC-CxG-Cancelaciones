...
import { Terminal, ShieldAlert, Search, RefreshCcw, User, Clock, Activity, FileText, ChevronRight, Database, ChevronDown, CheckCircle2, ShieldX } from 'lucide-react';
        ...
        return (
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center animate-in fade-in duration-700">
                <div className="relative mb-8">
                    ...
                    <div className="relative w-28 h-28 bg-white dark:bg-cb-bg rounded-[2.5rem] border border-cb-border shadow-cb-level-2 flex items-center justify-center text-rose-500 transform rotate-3 transition-transform hover:rotate-0 duration-500">
                        <ShieldX className="w-12 h-12 stroke-[1.5]" />
                        <div className="absolute -top-2 -right-2 w-8 h-8 bg-rose-500 text-white rounded-xl flex items-center justify-center shadow-lg animate-bounce">
                             <ShieldAlert className="w-5 h-5" />
                        </div>
                    </div>
                </div>
                <h2 className="text-3xl font-black text-foreground tracking-tight mb-3">Acceso bloqueado</h2>
                <p className="text-muted-foreground max-w-sm font-medium leading-relaxed mb-8 text-sm">
                    Este panel contiene registros de alta confidencialidad. Se requieren privilegios de seguridad adecuados para acceder a la trazabilidad del sistema.
                </p>
            </div>
        );
    }
        ...
        <div className="flex flex-col h-full space-y-4 min-h-0 animate-in fade-in duration-500">
            ...
            <div className={SIATC_THEME.LAYOUT.HEADER_WRAPPER}>
                <div className="space-y-1">
                    ...
                    <p className={SIATC_THEME.TYPOGRAPHY.PAGE_SUBTITLE}>Monitoreo transaccional y registro de eventos críticos de Gestor NC-CxG</p>
                </div>
                <button 
                    onClick={fetchLogs}
                    disabled={isLoading}
