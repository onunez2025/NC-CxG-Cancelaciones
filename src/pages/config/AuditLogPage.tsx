        ...
        <div className="flex flex-col h-full bg-background animate-in fade-in duration-500">
            ...
            <div className="p-6 bg-card border border-border rounded-t-lg flex justify-between items-center shrink-0">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Registro forense de intentos de acceso denegados y acciones críticas</p>
                </div>
                <button 
                    onClick={loadLogs}
                    className="text-xs font-medium px-4 py-2 bg-muted hover:bg-muted/80 rounded-md transition-colors shadow-sm"
                >
                    Actualizar Logs
                </button>
            </div>
            ...
            {/* Toolbar / Filters */}
            <div className="p-4 bg-muted/30 border-x border-border flex flex-col md:flex-row gap-4 shrink-0">
                                ...
                                <tr key={log.Id} className="hover:bg-muted/30 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-foreground font-medium">{log.UsuarioNombre}</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                        <span className={cn(
