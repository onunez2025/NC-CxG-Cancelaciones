...
export default function CostCentersPage() {
    ...
    // Pagination Logic
    const totalPages = Math.ceil(filteredCecos.length / recordsPerPage);
    const paginatedCecos = filteredCecos.slice((currentPage - 1) * recordsPerPage, currentPage * recordsPerPage);
