                        ...
                        <>
                            <thead className={SIATC_THEME.TABLE.HEADER_ROW}>
                                <tr className="border-b border-border">
                                    <SIATCTableHeader className="w-48">Código SAP</SIATCTableHeader>
                                    <SIATCTableHeader>Nombre del Centro</SIATCTableHeader>
                                    <SIATCTableHeader className="w-64">Gerencia Vinculada</SIATCTableHeader>
                                    <SIATCTableHeader className="w-40 text-center">Estado</SIATCTableHeader>
                                        ...
                                        <SIATCTableRow key={ceco.id}>
                                            ...
                                            <SIATCTableCell>
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[10px] text-muted-foreground font-medium mt-0.5 opacity-60">Centro de coste directo</span>
                                                </div>
                                            </SIATCTableCell>
                                            <SIATCTableCell>
