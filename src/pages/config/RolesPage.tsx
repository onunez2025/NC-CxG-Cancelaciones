...
import { Shield, Plus, Edit2, Trash2, Check, ChevronDown, Activity, Settings, BarChart3, Lock, ChevronRight, Database, AppWindow, ShieldAlert, Save } from 'lucide-react';
...
const PERMISSION_ROLES = 'config.roles';
...
export default function RolesPage() {
    ...
    const handleDelete = (id: string) => {
        confirm({
            ...
            message: `¿Estás seguro de que deseas eliminar este rol? Los usuarios asignados perderán sus facultades actuales en el sistema de ${APP_IDENTIFIER === 'CXG' ? 'Gestor NC-CxG' : 'SIATC'}.`,
            type: 'danger',
        ...
        <div className="flex flex-col h-full space-y-4 min-h-0 animate-in fade-in duration-500">
            ...
            <div className={SIATC_THEME.LAYOUT.HEADER_WRAPPER}>
                <div className="space-y-1">
                    ...
                    <p className={SIATC_THEME.TYPOGRAPHY.PAGE_SUBTITLE}>Define las facultades y niveles de acceso para las identidades de SIATC</p>
                </div>
                {hasPermission(PERMISSION_ROLES as any) && (
                    <button
