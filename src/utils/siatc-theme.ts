 ...
 * Single Source of Truth for EBM Platform
 * 
 * Este archivo ha sido optimizado para ser compatible con el ecosistema SIATC existente
 * permitiendo una migración instantánea de todos los componentes.
 */
...
export const SIATC_THEME = {
    ...
    LAYOUT: {
        ...
        SIDEBAR_ITEM_ACTIVE: "w-full text-left px-3 py-2.5 rounded-cb-btn transition-all relative group bg-primary text-primary-foreground font-bold shadow-md shadow-primary/20",
        SIDEBAR_ITEM_INACTIVE: "w-full text-left px-3 py-2.5 rounded-cb-btn transition-all relative group text-cb-text-secondary hover:bg-cb-bg dark:hover:bg-slate-800",
    ...
    // 7. ESTRUCTURA DE INICIO DE SESIÓN (LOGIN_LAYOUT) - Exportable/Reutilizable
    LOGIN_LAYOUT: {
