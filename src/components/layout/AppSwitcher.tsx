...
export function AppSwitcher({ currentAppId }: AppSwitcherProps) {
    ...
    return (
        <div className="relative inline-block" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-[432px] bg-white dark:bg-slate-950 backdrop-blur-md border border-black/10 dark:border-white/10 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.2)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.4)] z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-300">
                    <div className="p-5 border-b border-black/5 dark:border-white/5 bg-[#2563EB]">
                    ...
                    <div className="p-4 grid grid-cols-2 gap-4">
                        {otherApps.map(app => (
                            <a 
                                ...
                                className="group relative flex flex-col items-center justify-center p-6 rounded-xl hover:bg-blue-600/10 dark:hover:bg-blue-500/10 transition-all duration-500 border border-transparent hover:border-blue-200/50 dark:hover:border-blue-800/30 hover:shadow-[0_8px_30px_rgb(37,99,235,0.06)] dark:hover:shadow-[0_8px_30px_rgb(0,0,0,0.2)]"
                            >
                                ...
                                <span className="relative text-sm font-bold text-slate-900 dark:text-slate-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors text-center">
                                    {app.name}
                                </span>
                            </a>
                        ))}
